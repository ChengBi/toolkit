...
#             print(reschedule)
        ...
        with tf.name_scope('result_1'):
            ...
            tf.summary.scalar('model_1_loss', model_0_loss)
        with tf.name_scope('result_2'):
            ...
            tf.summary.scalar('model_2_loss', model_0_loss)
        with tf.name_scope('result_3'):
            ...
            tf.summary.scalar('model_3_loss', model_0_loss)
        with tf.name_scope('result_4'):
            ...
            tf.summary.scalar('model_4_loss', model_0_loss)
        with tf.name_scope('result_all'):
            ...
            tf.summary.scalar('model_loss', model_0_loss)
